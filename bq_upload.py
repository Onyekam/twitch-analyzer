...
import pandas as pd
from config import PROJECT_ID, DATASET_ID,TABLE_ID,GOOGLE_APPLICATION_CREDENTIALS,GAME_TABLE_ID,COVERS_TABLE_ID
import os
...
def upload_covers_data(data):
    
    project_id = PROJECT_ID
    # Set your BigQuery dataset and table name
    dataset_id = DATASET_ID
    table_id = COVERS_TABLE_ID
